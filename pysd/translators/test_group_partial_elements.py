        ...
        self.assertEqual(
                merge_partial_elements([{'py_name': 'a', 'expr': 'ms', 'subs': ['Name1', 'element1'],
                                        ...
                                        {'py_name': 'a', 'expr': 'as', 'subs': ['Name1', 'element3'],
                                         'real_name': 'A', 'doc':'',  'unit':None,
                                         'kind':'component'},
                                        {'py_name': 'b', 'expr': 'bgf', 'subs': ['Name1', 'element1'],
                                         'real_name': 'B', 'doc': 'Test', 'unit':None,
                                         'kind':'component'},
                                        {'py_name': 'b', 'expr': 'r4', 'subs': ['Name1', 'element2'],
                                         'real_name': 'B', 'doc':None,  'unit':None,
                                         'kind':'component'},
                                        {'py_name': 'b', 'expr': 'ymt', 'subs': ['Name1', 'element3'],
        ...
        self.assertEqual(
                merge_partial_elements([{'py_name': 'a', 'expr': 'ms', 'subs': ['Name1', 'element1'],
                                        ...
                                        {'py_name': 'a', 'expr': 'njk', 'subs': ['Name1', 'element2'],
                                         'real_name': 'A', 'doc':None,  'unit':None,
                                         'kind':'component'},
                                        {'py_name': 'c', 'expr': 'as', 'subs': ['Name1', 'element3'],
