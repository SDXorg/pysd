"""
Python model 'test_not_implemented_and_incomplete.py'
...
@component.add(
    name="not implemented function",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"time": 1},
)
def not_implemented_function_1():
    return not_implemented_function("my_func", time())
