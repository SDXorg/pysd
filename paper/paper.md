...
![Comparison of the current and upcoming model parsing-building logic in PySD. PEG acronym stands for Parsing Expression Grammar. \label{fig:ABSTRACTMODEL}](abstract_model.png)
